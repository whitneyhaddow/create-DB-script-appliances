...
IF EXISTS(SELECT 1 FROM master.dbo.sysdatabases WHERE name = 'AppRepairs') 
BEGIN
DROP DATABASE AppRepairs
END
GO

CREATE DATABASE AppRepairs
GO
...
GO
INSERT [dbo].[Products] ([ProductCode], [Name]) VALUES (N'DV5600     ', N'Electric Front-Load Dryer (Onyx)')
INSERT [dbo].[Products] ([ProductCode], [Name]) VALUES (N'DV8700     ', N'Electric Top-Load Dryer (Stainless Platinum)')
INSERT [dbo].[Products] ([ProductCode], [Name]) VALUES (N'DW80H9950  ', N'24 In. Dishwasher with Waterwall Technology')
INSERT [dbo].[Products] ([ProductCode], [Name]) VALUES (N'DW80J32020 ', N'24 In. Built-In Dishwasher Stainless Steel Tub')
INSERT [dbo].[Products] ([ProductCode], [Name]) VALUES (N'FE710DRS   ', N'Free Standing Self Clean Electric Range')
INSERT [dbo].[Products] ([ProductCode], [Name]) VALUES (N'RF220NCTAS ', N'3-Door French Refridgerator Black')
INSERT [dbo].[Products] ([ProductCode], [Name]) VALUES (N'RF260BEAEB ', N'French Door Refridgerator Stainless Steel')
INSERT [dbo].[Products] ([ProductCode], [Name]) VALUES (N'WA8700     ', N'Top-Load Washer (Stainless Platinum)')
INSERT [dbo].[Products] ([ProductCode], [Name]) VALUES (N'RWF9100    ', N'Front-Load Washer (Onyx)')
...
INSERT [dbo].[Registrations] ([CustomerID], [ProductCode], [RegistrationDate]) VALUES (1047, N'RWF9100    ', CAST(0x00009E3B00000000 AS DateTime))
...
INSERT [dbo].[Repairs] ([RepairID], [CustomerID], [ProductCode], [TechID], [DateReported], [DateRepaired], [Title], [Description]) VALUES (6,  1004, N'WA8700      ', 301, CAST(0x00009E5600000000 AS DateTime), NULL, N'Agitator needs replacing', N'Agitator quit working, not sure how long it''s been out of operation.')
...
INSERT [dbo].[Repairs] ([RepairID], [CustomerID], [ProductCode], [TechID], [DateReported], [DateRepaired], [Title], [Description]) VALUES (18, 1002, N'DV5600      ', NULL, CAST(0x00009E9D00000000 AS DateTime), NULL, N'Clothing routinely not drying', N'Customer states that the dryer worked fine previously and only recently has been performing badly.')
